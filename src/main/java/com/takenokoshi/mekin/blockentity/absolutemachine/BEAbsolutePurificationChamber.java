...
public class BEAbsolutePurificationChamber extends BEAbstractItemStackChemicalToItemStackMachine {

    public BEAbsolutePurificationChamber(Holder<Block> blockProvider, BlockPos pos, BlockState state) {
