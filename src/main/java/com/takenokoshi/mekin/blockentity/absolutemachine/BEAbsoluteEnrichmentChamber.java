...
public class BEAbsoluteEnrichmentChamber extends BEAbstractItemStackToItemStackMachine {

    public BEAbsoluteEnrichmentChamber(Holder<Block> blockProvider, BlockPos pos, BlockState state) {
