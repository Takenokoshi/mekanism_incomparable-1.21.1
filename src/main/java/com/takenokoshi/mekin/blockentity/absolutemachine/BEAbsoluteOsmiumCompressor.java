...
public class BEAbsoluteOsmiumCompressor extends BEAbstractItemStackChemicalToItemStackMachine {

    public BEAbsoluteOsmiumCompressor(Holder<Block> blockProvider, BlockPos pos, BlockState state) {
