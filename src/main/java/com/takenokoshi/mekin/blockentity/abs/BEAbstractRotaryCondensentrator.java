...
import static mekanism.common.tile.machine.TileEntityRotaryCondensentrator.NOT_ENOUGH_FLUID_INPUT_ERROR;
import static mekanism.common.tile.machine.TileEntityRotaryCondensentrator.NOT_ENOUGH_GAS_INPUT_ERROR;
import static mekanism.common.tile.machine.TileEntityRotaryCondensentrator.NOT_ENOUGH_SPACE_FLUID_OUTPUT_ERROR;
import static mekanism.common.tile.machine.TileEntityRotaryCondensentrator.NOT_ENOUGH_SPACE_GAS_OUTPUT_ERROR;
...
public abstract class BEAbstractRotaryCondensentrator extends TileEntityRecipeMachine<RotaryRecipe>
    ...
    @WrappingComputerMethod(wrapper = ComputerChemicalTankWrapper.class, methodNames = { "getGas", "getGasCapacity",
            "getGasNeeded",
    ...
    public BEAbstractRotaryCondensentrator(Holder<Block> blockProvider, BlockPos pos, BlockState state,
            int baselineMaxOperations) {
        super(blockProvider, pos, state, TRACKED_ERROR_TYPES);
        configComponent.setupItemIOConfig(List.of(gasInputSlot, fluidInputSlot),
                List.of(gasOutputSlot, fluidOutputSlot), energySlot, true);
    ...
    public IChemicalTankHolder getInitialChemicalTanks(IContentsListener listener,
        ...
        builder.addTank(gasTank = BasicChemicalTank.createModern(initChemicalTankCapacity(),
    ...
    protected IFluidTankHolder getInitialFluidTanks(IContentsListener listener, IContentsListener recipeCacheListener,
        ...
        builder.addTank(fluidTank = BasicFluidTank.create(initFluidTankCapacity(),
    ...
    protected IInventorySlotHolder getInitialInventory(IContentsListener listener,
        ...
        builder.addSlot(
                energySlot = EnergyInventorySlot.fillOrConvert(energyContainer, this::getLevel, listener, 155, 5));
    ...
    public RotaryRecipe getRecipe(int cacheIndex) {
        ...
        return mode ? inputCache.findFirstRecipe(level, fluidInputHandler.getInput())
                : inputCache.findFirstRecipe(level, gasInputHandler.getInput());
    }
    ...
    public CachedRecipe<RotaryRecipe> createNewCachedRecipe(@NotNull RotaryRecipe recipe, int cacheIndex) {
        return new RotaryCachedRecipe(recipe, recheckAllRecipeErrors, fluidInputHandler, gasInputHandler,
                gasOutputHandler, fluidOutputHandler, this::getMode)
