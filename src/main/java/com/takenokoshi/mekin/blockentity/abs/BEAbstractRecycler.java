...
import com.takenokoshi.mekin.recipe.cached.AdvancedRecyclerCachedRecipe;
...
public abstract class BEAbstractRecycler extends TileEntityProgressMachine<RecyclerRecipe>
        implements ISingleRecipeLookupHandler.ItemRecipeLookupHandler<RecyclerRecipe>, IHasMachineEnergyContainer,
    ...
    protected final IOutputHandler<MekInChanceOutput> outputHandler;

    protected BEAbstractRecycler(Holder<Block> blockProvider, BlockPos pos, BlockState state,
        ...
        outputHandler = initOutputHandler(outputSlot, RecipeError.NOT_ENOUGH_OUTPUT_SPACE);
        inputSlot.setSupplyingStackSetter(inputHandler::setSuppliedStack);
    }

    protected abstract IOutputHandler<MekInChanceOutput> initOutputHandler(IInventorySlot slot,
    ...
    @Override
    public @Nullable RecyclerRecipe getRecipe(int arg0) {
        return findFirstRecipe(inputHandler);
    }

    @Override
    public @NotNull CachedRecipe<RecyclerRecipe> createNewCachedRecipe(@NotNull RecyclerRecipe recipe, int arg1) {
        return new AdvancedRecyclerCachedRecipe(recipe, recheckAllRecipeErrors, inputHandler, outputHandler)
    ...
    @Override
    public @Nullable IRecipeViewerRecipeType<RecyclerRecipe> recipeViewerType() {
