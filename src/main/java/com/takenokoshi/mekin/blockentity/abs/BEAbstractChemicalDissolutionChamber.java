...
import com.takenokoshi.mekin.recipe.cached.AdvancedDissolutionCachedRecipe;
...
public abstract class BEAbstractChemicalDissolutionChamber extends TileEntityProgressMachine<ChemicalDissolutionRecipe>
        implements ConstantUsageRecipeLookupHandler,
        ItemChemicalRecipeLookupHandler<ChemicalDissolutionRecipe>, ISimpleItemStackChemicalToChemicalMachine,
    ...
    @WrappingComputerMethod(wrapper = ComputerChemicalTankWrapper.class, methodNames = { "getGasInput",
            "getGasInputCapacity", "getGasInputNeeded",
    ...
    private final AdvancedItemInputHandler itemInputHandler;
    private final AdvancedChemicalInputHandler gasInputHandler;
    ...
    ChemicalFillConvertOrSupplyingSlot gasInputSlot;
    ...
    protected double chemicalUsageModifier = 1.0d;

    private long clientEnergyUsed = 0L;

    protected BEAbstractChemicalDissolutionChamber(Holder<Block> blockProvider, BlockPos pos, BlockState state,
        ...
        gasInputHandler = AdvancedChemicalInputHandler.createConstant(injectTank);
    ...
    public IChemicalTankHolder getInitialChemicalTanks(IContentsListener listener,
        ...
        builder.addTank(injectTank = BasicChemicalTank.inputModern(initChemicalTankCapacity(),
                gas -> containsRecipeBA(inputSlot.getStack(), gas), this::containsRecipeB, recipeCacheListener));
    ...
    protected IInventorySlotHolder getInitialInventory(IContentsListener listener,
        ...
        builder.addSlot(
                gasInputSlot = ChemicalFillConvertOrSupplyingSlot.create(injectTank, this::getLevel, listener, 8, 65));
        builder.addSlot(inputSlot = InputOrSupplyingSlot.at(item -> containsRecipeAB(item, injectTank.getStack()),
                this::containsRecipeA, recipeCacheListener, 28, 36, initItemSlotCapacity()))
    ...
    @NotNull
    @Override
    public CachedRecipe<ChemicalDissolutionRecipe> createNewCachedRecipe(@NotNull ChemicalDissolutionRecipe recipe,
            int cacheIndex) {
        return new AdvancedDissolutionCachedRecipe(recipe, recheckAllRecipeErrors, itemInputHandler, gasInputHandler,
                outputHandler, this::getChemicalUsage)
