...
public class BEInfinitePurificationChamber extends BEAbstractItemStackChemicalToItemStackMachine {

    public BEInfinitePurificationChamber(Holder<Block> blockProvider, BlockPos pos, BlockState state) {
