...
public class BEInfiniteChemicalInjectionChamber extends BEAbstractItemStackChemicalToItemStackMachine {

    public BEInfiniteChemicalInjectionChamber(Holder<Block> blockProvider, BlockPos pos, BlockState state) {
