...
public class GuiChemicalExtractor<BE extends BEAbstractChemicalExtractor>
        extends GuiConfigurableTile<BE, MekanismTileContainer<BE>> {

    public GuiChemicalExtractor(MekanismTileContainer<BE> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiChemicalGauge(tile::getSubOutputTank, () -> tile.getChemicalTanks(null),
                GaugeType.STANDARD, this, 131, 13))
                .warning(WarningType.NO_SPACE_IN_OUTPUT,
                        tile.getWarningCheck(BEAbstractChemicalExtractor.NOT_ENOUGH_SUB_OUTPUT_SPACE));
