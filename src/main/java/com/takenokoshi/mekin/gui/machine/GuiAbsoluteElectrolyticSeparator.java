...
public class GuiAbsoluteElectrolyticSeparator<BE extends BEAbstractElectrolyticSeparator>
        extends GuiConfigurableTile<BE, MekanismTileContainer<BE>> {

    private GuiElement fluidGauge;

    public GuiAbsoluteElectrolyticSeparator(MekanismTileContainer<BE> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        fluidGauge = addRenderableWidget(new GuiFluidGauge(() -> tile.fluidTank, () -> tile.getFluidTanks(null),
                GaugeType.STANDARD, this, 5, 10))
                .warning(WarningType.NO_MATCHING_RECIPE, tile.getWarningCheck(RecipeError.NOT_ENOUGH_INPUT));
        addRenderableWidget(new GuiChemicalGauge(() -> tile.leftTank, () -> tile.getChemicalTanks(null),
                GaugeType.SMALL, this, 58, 18))
                .warning(WarningType.NO_SPACE_IN_OUTPUT,
                        tile.getWarningCheck(TileEntityElectrolyticSeparator.NOT_ENOUGH_SPACE_LEFT_OUTPUT_ERROR));
        addRenderableWidget(new GuiChemicalGauge(() -> tile.rightTank, () -> tile.getChemicalTanks(null),
                GaugeType.SMALL, this, 100, 18))
                .warning(WarningType.NO_SPACE_IN_OUTPUT,
                        tile.getWarningCheck(TileEntityElectrolyticSeparator.NOT_ENOUGH_SPACE_RIGHT_OUTPUT_ERROR));
