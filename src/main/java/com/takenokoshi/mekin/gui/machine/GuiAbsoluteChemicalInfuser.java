...
public class GuiAbsoluteChemicalInfuser<BE extends BEAbstractChemicalInfuser>
        extends GuiConfigurableTile<BE, MekanismTileContainer<BE>> {

    private GuiGauge<?> centerGauge;

    public GuiAbsoluteChemicalInfuser(MekanismTileContainer<BE> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        centerGauge = addRenderableWidget(new GuiChemicalGauge(() -> tile.centerTank, () -> tile.getChemicalTanks(null),
        ...
        addRenderableWidget(
                new GuiProgress(tile::getActive, ProgressType.SMALL_RIGHT, this, 47, 39).recipeViewerCategory(tile))
                .warning(WarningType.INPUT_DOESNT_PRODUCE_OUTPUT,
                        tile.getWarningCheck(RecipeError.INPUT_DOESNT_PRODUCE_OUTPUT));
        addRenderableWidget(
                new GuiProgress(tile::getActive, ProgressType.SMALL_LEFT, this, 101, 39).recipeViewerCategory(tile))
                .warning(WarningType.INPUT_DOESNT_PRODUCE_OUTPUT,
                        tile.getWarningCheck(RecipeError.INPUT_DOESNT_PRODUCE_OUTPUT));
    }
