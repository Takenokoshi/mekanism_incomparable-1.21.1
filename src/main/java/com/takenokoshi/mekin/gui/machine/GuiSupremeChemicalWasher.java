...
public class GuiSupremeChemicalWasher<BE extends BEAbstractChemicalWasher>
        extends GuiConfigurableTile<BE, MekanismTileContainer<BE>> {

    public GuiSupremeChemicalWasher(MekanismTileContainer<BE> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiChemicalGauge(() -> tile.inputTank, () -> tile.getChemicalTanks(null),
                GaugeType.STANDARD, this, 28, 13))
                .warning(WarningType.NO_MATCHING_RECIPE, tile.getWarningCheck(RecipeError.NOT_ENOUGH_INPUT));
        addRenderableWidget(new GuiChemicalGauge(() -> tile.outputTank, () -> tile.getChemicalTanks(null),
        ...
        addRenderableWidget(
                new GuiProgress(tile::getActive, ProgressType.LARGE_RIGHT, this, 64, 39))
