...
public class GuiLightningFabricator<BE extends BEAbstractLightningFabricator>
        extends GuiConfigurableTile<BE, MekanismTileContainer<BE>> {

    public GuiLightningFabricator(MekanismTileContainer<BE> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiChemicalGauge(tile::getChemicalTank, () -> tile.getChemicalTanks(null),
                GaugeType.SMALL, this, 28, 22)
                .warning(WarningType.NO_MATCHING_RECIPE, tile.getWarningCheck(NOT_ENOUGH_GAS_INPUT_ERROR)));
