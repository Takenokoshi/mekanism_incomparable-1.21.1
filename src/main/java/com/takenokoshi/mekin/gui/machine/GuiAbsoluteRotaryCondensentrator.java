...
public class GuiAbsoluteRotaryCondensentrator<BE extends BEAbstractRotaryCondensentrator>
        extends GuiConfigurableTile<BE, MekanismTileContainer<BE>> {

    private GuiElement energyBar;

    public GuiAbsoluteRotaryCondensentrator(MekanismTileContainer<BE> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiFluidGauge(() -> tile.fluidTank, () -> tile.getFluidTanks(null), GaugeType.STANDARD,
                this, 133, 13))
                .warning(WarningType.NO_MATCHING_RECIPE,
                        tile.getWarningCheck(TileEntityRotaryCondensentrator.NOT_ENOUGH_FLUID_INPUT_ERROR))
                .warning(WarningType.NO_SPACE_IN_OUTPUT,
                        tile.getWarningCheck(TileEntityRotaryCondensentrator.NOT_ENOUGH_SPACE_FLUID_OUTPUT_ERROR));
        addRenderableWidget(new GuiChemicalGauge(() -> tile.gasTank, () -> tile.getChemicalTanks(null),
                GaugeType.STANDARD, this, 25, 13))
                .warning(WarningType.NO_MATCHING_RECIPE,
                        tile.getWarningCheck(TileEntityRotaryCondensentrator.NOT_ENOUGH_GAS_INPUT_ERROR))
                .warning(WarningType.NO_SPACE_IN_OUTPUT,
                        tile.getWarningCheck(TileEntityRotaryCondensentrator.NOT_ENOUGH_SPACE_GAS_OUTPUT_ERROR));
    ...
    protected void drawForegroundText(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        drawScrollingString(guiGraphics, modeLang.translate(), 4, imageHeight - 92, TextAlignment.LEFT,
                titleTextColor(), energyBar.getRelativeX() - 4, 2, false);
