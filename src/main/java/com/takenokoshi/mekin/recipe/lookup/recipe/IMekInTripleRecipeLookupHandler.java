...
import com.takenokoshi.mekin.recipe.inputcache.MekInTripleInputRecipeCache.MekInItemFluidChemical;
...
public interface IMekInTripleRecipeLookupHandler<INPUT_A, INPUT_B, INPUT_C, RECIPE extends MekanismRecipe<?> & TriPredicate<INPUT_A, INPUT_B, INPUT_C>, INPUT_CACHE extends MekInTripleInputRecipeCache<INPUT_A, ?, INPUT_B, ?, INPUT_C, ?, RECIPE, ?, ?, ?>>
     ...
     *
     * @apiNote See
     *          {@link TripleInputRecipeCache#containsInputABC(Level, Object, Object, Object)},
     *          {@link TripleInputRecipeCache#containsInputBAC(Level, Object, Object, Object)},
     *          and
     *          {@link TripleInputRecipeCache#containsInputCAB(Level, Object, Object, Object)}
     *          for more details about when this method should be called versus when
     *          {@link #containsRecipeBAC(Object, Object, Object)} or
     ...
     *          {@link TripleInputRecipeCache#containsInputCAB(Level, Object, Object, Object)}
     *          for more details about when this method should be called versus when
     *          {@link #containsRecipeABC(Object, Object, Object)} or
     *          {@link #containsRecipeCAB(Object, Object, Object)} should be called.
     */
    ...
    static interface MekInItemFluidChemicalRecipeLookupHandler<RECIPE extends MekanismRecipe<?> & TriPredicate<ItemStack, FluidStack, ChemicalStack>>
            extends
            IMekInTripleRecipeLookupHandler<ItemStack, FluidStack, ChemicalStack, RECIPE, MekInItemFluidChemical<RECIPE>> {
    }
}
